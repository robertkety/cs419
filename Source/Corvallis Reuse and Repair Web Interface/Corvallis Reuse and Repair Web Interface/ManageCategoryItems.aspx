...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PanelCategoryItems" runat="server" Visible="false">
        ...
        <asp:GridView ID="GridViewCategoryItems" runat="server" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" 
            GridLines="None" OnPageIndexChanged="GridViewCategoryItems_PageIndexChanged" OnPageIndexChanging="GridViewCategoryItems_PageIndexChanging" 
            ShowFooter="True" OnRowCancelingEdit="GridViewCategoryItems_RowCancelingEdit" OnRowEditing="GridViewCategoryItems_RowEditing" OnRowUpdating="GridViewCategoryItems_RowUpdating">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:TemplateField HeaderText="Item ID" Visible="false" HeaderStyle-Width="0%" ItemStyle-Width="0%">
                    <ItemTemplate>
                        <%# Eval("ItemID") %>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Item Name" Visible="true" HeaderStyle-Width="60%" ItemStyle-Width="60%">
                    <ItemTemplate>
                        <%# Eval("ItemName") %>
                    </ItemTemplate>
                    <FooterTemplate>
